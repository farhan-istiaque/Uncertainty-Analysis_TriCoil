...
for filename in files:
    ...
    print("Capacity of Air in W: ", Q_air/1000)
    print("Sensible Capacity of Air in W: ", Q_air_sens/1000)
    print("Capacity of Water in W: ", Q_water/1000)
    print("Capacity of Refrigerant in W: ", Q_refr/1000)
