...
data_file_loc = prj_fold_loc + "\\03-Trimmed Raw Data\\one_nozzle\\"
...
for filename in files:
    ...
    #P_r_in_avg = np.mean(P_r_in)
    #P_r_out_avg = np.mean(P_r_out)
    ...
    Contr_Q_a.append(Error_a[2]) #NDD
    Contr_Q_a.append(Error_a[3]) #mu
    Contr_Q_a.append(Error_a[4] + Error_a[6]) #rho
    ...
    Contr_Q_a_s.append(Error_a_sens[2]) #NDD
    Contr_Q_a_s.append(Error_a[3]) #mu
    Contr_Q_a_s.append(Error_a[4] + Error_a_sens[6]) #rho
